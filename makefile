...
_ROOT       := $(_THIS)
EVALFILE     = nn.net
NNZ_PROFILE  = nnz-activations.txt
CXX         := g++
TARGET      := Alexandria
...
$(EVALFILE_PROCESSED): $(EVALFILE) $(NNZ_PROFILE) tools/preprocess.cpp src/nnue.h src/simd.h
	...
	./$(PREPROCESSOR) $(EVALFILE) $(EVALFILE_PROCESSED) $(NNZ_PROFILE)
