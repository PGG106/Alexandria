...
void print_info(S_SearchINFO* info) {
	...
	printf("Search Start time: %llu\n", info->starttime);
	printf("Search StopOpt time: %llu\n", info->stoptimeOpt);
	printf("Search StopMax time: %llu\n", info->stoptimeMax);
	printf("Search Depth: %d\n", info->depth);
	printf("Search SelDepth: %d\n", info->seldepth);
	printf("Search Depthset: %d\n", info->depthset);
	printf("Search Timeset: %d\n", info->timeset);
	printf("Search Nodeset: %d\n", info->nodeset);
	printf("Search MTG: %d\n", info->movestogo);
	printf("Search nodeslimit: %d\n", info->nodeslimit);
	printf("Search Infinite: %d\n", info->infinite);
	printf("Search Quit: %d\n", info->quit);
	printf("Search Stopped: %d\n", info->stopped);
