...
#define MAXGAMEMOVES                                                           \
  1024 // maximum number of moves possibile,no recorderd game has ever gone past
       // 1000 moves so it shoukd be a good approximation
#define MAXDEPTH 64
...
typedef struct Board {
  ...
  int castleperm; // integer that represents the castling permission in his bits
                  // (1111) = all castlings allowed (0000) no castling allowed,
                  // (0101) only WKCA and BKCA allowed...
