...
TUNE_PARAM(nmpReductionEvalDivisor, 204, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 28, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 192, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 251, 100, 400, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 292, 100, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 59, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8046, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5845, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 99, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 264, -500, 500, 25, 0.002)
TUNE_PARAM(hindsightEval, 149, 50, 300, 10, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 324, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 73, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2540, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 385, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 96, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 639, 1, 4096, 256, 0.002)
// PH
TUNE_PARAM(pawnhistoryBonusMul, 260, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, 198, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2112, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 369, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 88, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 745, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 342, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -78, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2003, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 340, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -55, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1497, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 148, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -114, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2532, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 243, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, -53, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 1505, 1, 4096, 256, 0.002)
// Roothist
TUNE_PARAM(roothistoryBonusMul, 225, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 73, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 2286, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 365, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 92, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 961, 1, 4096, 256, 0.002)
// LMR
...
TUNE_PARAM(lmrNoisytDivisor, 224, 150, 500, 15, 0.002)
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8220, 1, 16383, 100, 0.002)
TUNE_PARAM(seeQuietMargin, -95, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -26, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 257, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 111, 40, 200, 10, 0.002)
TUNE_PARAM(histPruningMargin, -4363, -16384, 0, 256, 0.002)
