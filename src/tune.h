...
// PH
TUNE_PARAM(pawnhistoryBonusMul, 292, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, 292, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2279, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 347, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 504, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 1792, 1, 4096, 256, 0.002)
// Capthist
