...
// TM STUFF
// SOFT/HARD bounds
TUNE_PARAM(baseMultiplier, 60, 20, 150, 7, 0.002)
TUNE_PARAM(incMultiplier, 87, 50, 150, 5, 0.002)
TUNE_PARAM(maxBoundMultiplier, 76, 50, 90, 2, 0.002)
TUNE_PARAM(optTimeMultiplier, 76, 50, 90, 2, 0.002)
TUNE_PARAM(maxTimeMultiplier, 277, 100, 500, 20, 0.002)
...
TUNE_PARAM(evalScale2, 123, 80, 150, 4, 0.002)
TUNE_PARAM(evalScale3, 102, 80, 150, 4, 0.002)
TUNE_PARAM(evalScale4, 98, 60, 130, 4, 0.002)
...
// Search
TUNE_PARAM(rfpMargin, 70, 40, 200, 10, 0.002)
...
TUNE_PARAM(historyNoisyLmrDivisor, 6057, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 110, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 250, -500, 500, 25, 0.002)
TUNE_PARAM(historyBonusMax, 1369, 1, 4096, 256, 0.002)
TUNE_PARAM(lmrQuietBase, 100, 40, 150, 7, 0.002)
TUNE_PARAM(lmrQuietDivisor, 219, 150, 500, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -26, -70, 100, 7, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 222, 150, 500, 15, 0.002)
TUNE_PARAM(seeQuietMargin, -90, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -32, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 246, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 149, 40, 200, 10, 0.002)
TUNE_PARAM(lmrDepthDivisor, 8252, 1, 16383, 100, 0.002)
