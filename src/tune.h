...
TUNE_PARAM(pawnhistoryBonusOffset, 115, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2103, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 388, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 62, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 891, 1, 4096, 256, 0.002)
// Capthist
