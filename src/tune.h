...
TUNE_PARAM(aspWinPrevevalDiv, 18882, 12000, 25000, 512, 0.002)
TUNE_PARAM(evalHistSlope, -11, -30, 10, 2, 0.002)
TUNE_PARAM(evalHistMin, -1819, -3000, 0, 64, 0.002)
TUNE_PARAM(evalHistMax, 1453, 0, 3000, 64, 0.002)
TUNE_PARAM(evalHistOffset, 612, -1000, 2000, 32, 0.002)
TUNE_PARAM(rfpDepthMargin, 74, 40, 200, 10, 0.002)
TUNE_PARAM(rfpImprovingMargin, 65, 40, 200, 10, 0.002)
TUNE_PARAM(rfpIIRMargin, 75, 40, 200, 10, 0.002)
TUNE_PARAM(rfpMaxDepth, 9, 1, 15, 1, 0.002)
TUNE_PARAM(rfpMinMargin, -94, -300, 200, 8, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 216, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 28, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 213, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 313, 100, 400, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 288, 100, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 56, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8100, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5924, 1, 16383, 100, 0.002)
...
TUNE_PARAM(singularBetaNumerator, 5, 1, 12, 1, 0.002)
TUNE_PARAM(singularBetaDenominator, 8, 1, 16, 1, 0.002)
TUNE_PARAM(singularBetaPvPenalty, 1, 0, 3, 1, 0.002)
...
// HH
TUNE_PARAM(historyBonusMul, 342, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 167, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2795, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 407, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 129, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 274, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 354, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -132, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2289, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 325, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -120, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1514, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 161, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -156, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2339, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 396, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 74, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 792, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryTTMalusMul, 161, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryTTMalusMax, 381, 1, 2048, 64, 0.002)
// Pawnhist
TUNE_PARAM(pawnhistoryBonusMul, 173, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, -52, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2428, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 395, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 56, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 640, 1, 4096, 256, 0.002)
// Corrhist
TUNE_PARAM(corrhistoryPawnWeight, 28, 1, 256, 4, 0.002)
TUNE_PARAM(corrhistoryNonPawnWeight, 34, 1, 256, 4, 0.002)
TUNE_PARAM(contCorrthistoryWeight, 28, 1, 256, 4, 0.002)

// Roothist
TUNE_PARAM(roothistoryBonusMul, 236, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 161, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 1583, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 412, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 93, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 783, 1, 4096, 256, 0.002)
// LMR
...
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8260, 1, 16383, 100, 0.002)
TUNE_PARAM(seeQuietMargin, -99, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -28, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 225, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 120, 40, 200, 10, 0.002)
TUNE_PARAM(histPruningMargin, -3559, -16384, 0, 256, 0.002)
