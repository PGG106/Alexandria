...
// HH
TUNE_PARAM(historyBonusMul, 200, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 21, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2500, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 317, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 50, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 865, 1, 4096, 256, 0.002)
// PH
TUNE_PARAM(pawnhistoryBonusMul, 200, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, 21, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2500, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 317, 1, 1500, 32, 0.002)
