...
// Search
TUNE_PARAM(aspWinDelta, 7, 2, 15, 2, 0.002)
TUNE_PARAM(aspWinPrevevalDiv, 18668, 12000, 25000, 512, 0.002)
TUNE_PARAM(rfpDepthMargin, 78, 40, 200, 10, 0.002)
TUNE_PARAM(rfpImprovingMargin, 66, 40, 200, 10, 0.002)
TUNE_PARAM(rfpIIRMargin, 68, 40, 200, 10, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 214, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 28, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 216, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 264, 100, 400, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 277, 100, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 60, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8068, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5971, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 89, 1, 200, 20, 0.002)
TUNE_PARAM(hindsightEval, 154, 50, 300, 10, 0.002)
TUNE_PARAM(qsBaseFutility, 274, -500, 500, 25, 0.002)
TUNE_PARAM(qsSEEmargin, -54, -150, 1, 10, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 348, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 173, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2762, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 400, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 98, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 347, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 343, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -99, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2283, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 319, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -24, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1405, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 160, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -144, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2528, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 384, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 159, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 747, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryTTMalusMul, 150, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryTTMalusMax, 395, 1, 2048, 64, 0.002)
// Pawnhist
TUNE_PARAM(pawnhistoryBonusMul, 167, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, -77, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2553, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 399, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 16, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 723, 1, 4096, 256, 0.002)
// Corrhist
TUNE_PARAM(corrhistoryPawnWeight, 27, 1, 256, 4, 0.002)
TUNE_PARAM(corrhistoryNonPawnWeight, 34, 1, 256, 4, 0.002)
TUNE_PARAM(contCorrthistoryWeight, 28, 1, 256, 4, 0.002)

// Roothist
TUNE_PARAM(roothistoryBonusMul, 230, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 178, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 1754, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 408, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 68, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 908, 1, 4096, 256, 0.002)
// LMR
TUNE_PARAM(lmrQuietBase, 110, 40, 150, 7, 0.002)
TUNE_PARAM(lmrQuietDivisor, 228, 150, 500, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -34, -70, 100, 7, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 251, 150, 500, 15, 0.002)
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8297, 1, 16383, 100, 0.002)
TUNE_PARAM(seeQuietMargin, -99, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -29, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 227, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 117, 40, 200, 10, 0.002)
TUNE_PARAM(histPruningMargin, -3826, -16384, 0, 256, 0.002)
