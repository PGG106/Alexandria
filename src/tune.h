...
// TM STUFF
// SOFT/HARD bounds
TUNE_PARAM(baseMultiplier, 56, 20, 150, 7, 0.002)
...
// Bestmove stability
TUNE_PARAM(bmScale1, 258, 50, 300, 10, 0.002)
TUNE_PARAM(bmScale2, 154, 50, 200, 10, 0.002)
...
TUNE_PARAM(evalScale3, 99, 80, 150, 4, 0.002)
TUNE_PARAM(evalScale4, 98, 60, 130, 4, 0.002)
TUNE_PARAM(evalScale5, 83, 40, 110, 4, 0.002)

// Node Tm
TUNE_PARAM(nodeTmBase, 143, 100, 300, 10, 0.002)
TUNE_PARAM(nodeTmMultiplier, 192, 80, 250, 8, 0.002)


// Search
TUNE_PARAM(rfpDepthMargin, 90, 40, 200, 10, 0.002)
...
TUNE_PARAM(historyQuietLmrDivisor, 8218, 1, 16383, 100, 0.002)
...
TUNE_PARAM(lmrNoisytDivisor, 217, 150, 500, 15, 0.002)
TUNE_PARAM(seeQuietMargin, -93, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -33, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 230, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 134, 40, 200, 10, 0.002)
TUNE_PARAM(lmrDepthDivisor, 8154, 1, 16383, 100, 0.002)
