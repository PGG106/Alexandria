...
TUNE_PARAM(maxBoundMultiplier, 75, 50, 90, 2, 0.002)
...
TUNE_PARAM(bmScale2, 146, 50, 200, 10, 0.002)
TUNE_PARAM(bmScale3, 118, 50, 150, 6, 0.002)
TUNE_PARAM(bmScale4, 89, 40, 110, 5, 0.002)
...
TUNE_PARAM(nodeTmMultiplier, 179, 80, 250, 8, 0.002)


// Search
TUNE_PARAM(rfpMargin, 80, 40, 200, 10, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 197, 100, 400, 20, 0.002)
TUNE_PARAM(razoringCoeff, 254, 100, 400, 20, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8184, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 6056, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 116, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 273, -500, 500, 25, 0.002)
TUNE_PARAM(historyBonusMax, 1321, 1, 4096, 256, 0.002)
TUNE_PARAM(lmrQuietBase, 101, 40, 150, 7, 0.002)
TUNE_PARAM(lmrQuietDivisor, 223, 150, 500, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -23, -70, 100, 7, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 239, 150, 500, 15, 0.002)
TUNE_PARAM(seeQuietMargin, -90, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -33, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 244, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 145, 40, 200, 10, 0.002)
TUNE_PARAM(lmrDepthDivisor, 8184, 1, 16383, 100, 0.002)
