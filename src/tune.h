...
// Search
TUNE_PARAM(rfpDepthMargin, 80, 40, 200, 10, 0.002)
TUNE_PARAM(rfpImprovingMargin, 60, 40, 200, 10, 0.002)
TUNE_PARAM(rfpIIRMargin, 82, 40, 200, 10, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 225, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 29, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 214, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 244, 100, 400, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 282, 100, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 62, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8100, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 6029, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 74, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 293, -500, 500, 25, 0.002)
TUNE_PARAM(hindsightEval, 152, 50, 300, 10, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 332, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 165, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2852, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 407, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 119, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 255, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 342, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -46, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2122, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 327, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -98, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1185, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 172, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -177, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2355, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 381, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 102, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 852, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryTTMalusMul, 151, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryTTMalusMax, 386, 1, 2048, 64, 0.002)
// Corrhist
...
// Roothist
TUNE_PARAM(roothistoryBonusMul, 215, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 168, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 1881, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 390, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 103, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 785, 1, 4096, 256, 0.002)
// LMR
...
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8287, 1, 16383, 100, 0.002)
TUNE_PARAM(seeQuietMargin, -97, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -28, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 229, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 118, 40, 200, 10, 0.002)
TUNE_PARAM(histPruningMargin, -3957, -16384, 0, 256, 0.002)

// Mat scaling
TUNE_PARAM(PawnMatScaling, 99, 50, 150, 5, 0.002)
TUNE_PARAM(KnightMatScaling, 435, 250, 500, 15, 0.002)
TUNE_PARAM(BishopMatScaling, 426, 250, 500, 15, 0.002)
TUNE_PARAM(RookMatScaling, 645, 350, 800, 15, 0.002)
TUNE_PARAM(QueenMatScaling, 1025, 570, 1350, 25, 0.002)
TUNE_PARAM(MatScaleFixed, 22433, 15000, 30000, 50, 0.002)
