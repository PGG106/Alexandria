...
TUNE_PARAM(rfpIIRMargin, 84, 40, 200, 10, 0.002)
...
TUNE_PARAM(probcutBaseMargin, 274, 100, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 63, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8016, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5907, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 64, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 283, -500, 500, 25, 0.002)
TUNE_PARAM(hindsightEval, 144, 50, 300, 10, 0.002)
//SE
TUNE_PARAM(doubleExtMargin, 11, -10, 50, 2, 0.002)
TUNE_PARAM(tripleExtMargin, 75, -10, 150, 8, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 371, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 189, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 3045, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 386, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 162, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 293, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 322, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -45, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2354, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 324, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -7, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1332, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 167, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -131, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2257, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 422, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 93, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 789, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryTTMalusMul, 133, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryTTMalusMax, 408, 1, 2048, 64, 0.002)
// Corrhist
TUNE_PARAM(corrhistoryPawnWeight, 27, 1, 256, 4, 0.002)
TUNE_PARAM(corrhistoryNonPawnWeight, 33, 1, 256, 4, 0.002)
TUNE_PARAM(contCorrthistoryWeight, 27, 1, 256, 4, 0.002)

// Roothist
TUNE_PARAM(roothistoryBonusMul, 222, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 115, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 1857, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 417, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 24, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 977, 1, 4096, 256, 0.002)
// LMR
TUNE_PARAM(lmrQuietBase, 111, 40, 150, 7, 0.002)
TUNE_PARAM(lmrQuietDivisor, 212, 150, 500, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -32, -70, 100, 7, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 251, 150, 500, 15, 0.002)
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8266, 1, 16383, 100, 0.002)
TUNE_PARAM(seeQuietMargin, -100, -150, -20, 5, 0.002)
TUNE_PARAM(seeNoisyMargin, -25, -100, -1, 3, 0.002)
TUNE_PARAM(futilityCoeff0, 228, 40, 300, 10, 0.002)
TUNE_PARAM(futilityCoeff1, 108, 40, 200, 10, 0.002)
TUNE_PARAM(histPruningMargin, -3860, -16384, 0, 256, 0.002)
