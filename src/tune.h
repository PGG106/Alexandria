...
TUNE_PARAM(rfpIIRMargin, 70, 40, 200, 10, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 222, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 27, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 214, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 272, 100, 400, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 290, 100, 400, 10, 0.002)
TUNE_PARAM(probcutImprovingOffset, 61, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8070, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5906, 1, 16383, 100, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 81, 1, 200, 20, 0.002)
TUNE_PARAM(qsBaseFutility, 280, -500, 500, 25, 0.002)
TUNE_PARAM(hindsightEval, 156, 50, 300, 10, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 330, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 141, -1024, 1024, 32, 0.002)
TUNE_PARAM(historyBonusMax, 2891, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 393, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 122, -1024, 1024, 32, 0.002)
TUNE_PARAM(historyMalusMax, 578, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 348, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -105, -1024, 1024, 32, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2434, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 308, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -95, -1024, 1024, 32, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1371, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 153, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -116, -1024, 1024, 32, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2621, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 390, 1, 1500, 16, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 96, -1024, 1024, 32, 0.002)
TUNE_PARAM(conthistoryMalusMax, 801, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryTTMalusMul, 147, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryTTMalusMax, 392, 1, 2048, 32, 0.002)
// Corrhist
TUNE_PARAM(corrhistoryPawnWeight, 26, 1, 256, 3, 0.002)
TUNE_PARAM(corrhistoryNonPawnWeight, 32, 1, 256, 3, 0.002)
TUNE_PARAM(contCorrthistoryWeight, 25, 1, 256, 3, 0.002)

// Roothist
TUNE_PARAM(roothistoryBonusMul, 222, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 166, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 1800, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 402, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 45, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 980, 1, 4096, 256, 0.002)
// LMR
TUNE_PARAM(lmrQuietBase, 107, 40, 150, 7, 0.002)
TUNE_PARAM(lmrQuietDivisor, 223, 150, 500, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -37, -70, 100, 5, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 253, 150, 500, 15, 0.002)
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8243, 1, 16383, 100, 0.002)
...
TUNE_PARAM(histPruningMargin, -3877, -16384, 0, 256, 0.002)