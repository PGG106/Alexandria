...
// Search
TUNE_PARAM(rfpDepthMargin, 81, 40, 150, 8, 0.002)
TUNE_PARAM(rfpImprovingMargin, 61, 40, 100, 8, 0.002)
TUNE_PARAM(rfpIIRMargin, 78, 40, 150, 8, 0.002)
TUNE_PARAM(nmpReductionEvalDivisor, 202, 100, 250, 10, 0.002)
TUNE_PARAM(nmpDepthMargin, 29, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 192, -300, 300, 20, 0.002)
TUNE_PARAM(razoringCoeff, 247, 100, 300, 20, 0.002)
TUNE_PARAM(probcutBaseMargin, 288, 150, 400, 20, 0.002)
TUNE_PARAM(probcutImprovingOffset, 55, -150, 150, 10, 0.002)
TUNE_PARAM(historyQuietLmrDivisor, 8134, 4096, 16383, 150, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5873, 4096, 16383, 150, 0.002)
TUNE_PARAM(doDeeperBaseMargin, 88, 20, 200, 15, 0.002)
TUNE_PARAM(qsBaseFutility, 282, -100, 500, 25, 0.002)
...
TUNE_PARAM(conthistoryMalusMul, 248, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 19, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 1500, 1, 4096, 256, 0.002)
// Roothist
...
TUNE_PARAM(lmrQuietDivisor, 222, 150, 300, 15, 0.002)
TUNE_PARAM(lmrNoisyBase, -41, -70, 100, 7, 0.002)
TUNE_PARAM(lmrNoisytDivisor, 234, 150, 500, 15, 0.002)
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8285, 4096, 16383, 100, 0.002)
