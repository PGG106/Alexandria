...
// PH
TUNE_PARAM(pawnhistoryBonusMul, 313, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryBonusOffset, 21, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryBonusMax, 2663, 1, 4096, 256, 0.002)
TUNE_PARAM(pawnhistoryMalusMul, 377, 1, 1500, 32, 0.002)
TUNE_PARAM(pawnhistoryMalusOffset, 50, -1024, 1024, 64, 0.002)
TUNE_PARAM(pawnhistoryMalusMax, 865, 1, 4096, 256, 0.002)
// Capthist
