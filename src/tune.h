...
TUNE_PARAM(nmpReductionEvalDivisor, 185, 100, 400, 20, 0.002)
TUNE_PARAM(nmpDepthMargin, 28, 20, 40, 2, 0.002)
TUNE_PARAM(nmpOffset, 208, -300, 300, 20, 0.002)
...
TUNE_PARAM(historyQuietLmrDivisor, 8083, 1, 16383, 100, 0.002)
TUNE_PARAM(historyNoisyLmrDivisor, 5986, 1, 16383, 100, 0.002)
...
TUNE_PARAM(tripleExtMargin, 73, 30, 150, 10, 0.002)
// HH
TUNE_PARAM(historyBonusMul, 343, 1, 1500, 32, 0.002)
TUNE_PARAM(historyBonusOffset, 18, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyBonusMax, 2567, 1, 4096, 256, 0.002)
TUNE_PARAM(historyMalusMul, 360, 1, 1500, 32, 0.002)
TUNE_PARAM(historyMalusOffset, 28, -1024, 1024, 64, 0.002)
TUNE_PARAM(historyMalusMax, 707, 1, 4096, 256, 0.002)
// Capthist
TUNE_PARAM(capthistoryBonusMul, 313, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryBonusOffset, -81, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2036, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 299, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -28, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1407, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 150, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -155, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2774, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 238, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 19, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryMalusMax, 1466, 1, 4096, 256, 0.002)
// Roothist
TUNE_PARAM(roothistoryBonusMul, 167, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryBonusOffset, 112, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryBonusMax, 2302, 1, 4096, 256, 0.002)
TUNE_PARAM(roothistoryMalusMul, 375, 1, 1500, 32, 0.002)
TUNE_PARAM(roothistoryMalusOffset, 102, -1024, 1024, 64, 0.002)
TUNE_PARAM(roothistoryMalusMax, 861, 1, 4096, 256, 0.002)
// LMR
...
// Forward pruning
TUNE_PARAM(lmrDepthDivisor, 8168, 1, 16383, 100, 0.002)
...
TUNE_PARAM(histPruningMargin, -3868, -16384, 0, 256, 0.002)
