...
TUNE_PARAM(evalHistMin, -1830, -3000, 0, 64, 0.002)
TUNE_PARAM(evalHistMax, 1427, 0, 3000, 64, 0.002)
TUNE_PARAM(evalHistOffset, 624, -1000, 2000, 32, 0.002)
...
TUNE_PARAM(rfpMinMargin, -100, -300, 200, 8, 0.002)
...
TUNE_PARAM(razoringCoeff, 300, 100, 400, 20, 0.002)
...
TUNE_PARAM(singularDoubleExtensionMargin, 10, 0, 100, 4, 0.002)
TUNE_PARAM(singularTripleExtensionMargin, 75, 0, 200, 8, 0.002)
TUNE_PARAM(qsBaseFutility, 268, -500, 500, 25, 0.002)
TUNE_PARAM(qsSEEmargin, -50, -150, 1, 10, 0.002)
// HH
...
TUNE_PARAM(capthistoryBonusOffset, -76, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryBonusMax, 2296, 1, 4096, 256, 0.002)
TUNE_PARAM(capthistoryMalusMul, 310, 1, 1500, 32, 0.002)
TUNE_PARAM(capthistoryMalusOffset, -88, -1024, 1024, 64, 0.002)
TUNE_PARAM(capthistoryMalusMax, 1306, 1, 4096, 256, 0.002)
// Conthist
TUNE_PARAM(conthistoryBonusMul, 159, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryBonusOffset, -135, -1024, 1024, 64, 0.002)
TUNE_PARAM(conthistoryBonusMax, 2538, 1, 4096, 256, 0.002)
TUNE_PARAM(conthistoryMalusMul, 401, 1, 1500, 32, 0.002)
TUNE_PARAM(conthistoryMalusOffset, 114, -1024, 1024, 64, 0.002)
