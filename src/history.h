...
[[nodiscard]] int GetCHScore(const Position *pos, const SearchStack* ss, const Move move);
[[nodiscard]] int GetSingleCHScore(const Position *pos, const SearchStack* ss, const Move move, const int offset);
