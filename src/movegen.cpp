...
static inline void PseudoLegalPawnMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
...
static inline void PseudoLegalKnightMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
...
static inline void PseudoLegalBishopMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
...
static inline void PseudoLegalRookMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
...
static inline void PseudoLegalQueenMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
...
static inline void PseudoLegalKingMoves(Position* pos, int color, S_MOVELIST* list, bool capOnly) {
